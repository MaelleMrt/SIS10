...
public class InfirmiereSoins extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Trier par...", "Infirmier", "Date" }));
    ...
    private void jTable1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MousePressed
        ...
        if(evt.getButton() == MouseEvent.BUTTON1 ||
                    evt.getButton() == MouseEvent.BUTTON3)
                {
                    ...
                    try{
                        Soins soin=new Soins(Integer.parseInt(jTable1.getValueAt(indRow, 0).toString()),Integer.parseInt(jTable1.getValueAt(indRow, 1).toString()),Integer.parseInt(jTable1.getValueAt(indRow, 2).toString()),Integer.parseInt(jTable1.getValueAt(indRow, 3).toString()),Integer.parseInt(jTable1.getValueAt(indRow, 4).toString()),Integer.parseInt(jTable1.getValueAt(indRow, 5).toString()),jTable1.getValueAt(indRow, 6).toString(),jTable1.getValueAt(indRow, 7).toString(),jTable1.getValueAt(indRow, 8).toString());
                        this.dispose();
                        new ContenuInfSoins(soin,patient,infirmier);
                    }catch(Exception e2){
                    }
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        ...
        if (jComboBox1.getSelectedItem().equals("Infirmier")) {
            list = new Tri().trierSoinsParInf(list);
        }
        else if (jComboBox1.getSelectedItem().equals("Date")) {
            list = new Tri().trierSoinsParDate(list);
        }
        ...
        for (Soins p : list) {
            ...
            v.add(p.getFc());
            v.add(p.getPa());
            v.add(p.getSaturation());
            v.add(p.getGly());
            v.add(p.getObservation());
            v.add(p.getDate());
            v.add(p.getNomInf());
            model.setColumnIdentifiers(new String[]{"Poids ", "Température", "FC","PA","Saturation","Glycemie","Observation","date","infirmier"});
            model.insertRow(i, v);
            i++;
        }
